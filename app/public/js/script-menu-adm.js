...
const PaginaSelecionadaNoMenu = () => {
    ...
    if(urlDaPagina.includes('/administrativa')){
        pagina = pag1;
    ...
    else if(urlDaPagina.includes('/adm-postagens')){
        pagina = pag3;
    ...
    else if(urlDaPagina.includes('/adm-premium')){
        pagina = pag5;
    ...
    else if(urlDaPagina.includes('/adm-banners')){
        pagina = pag6;
